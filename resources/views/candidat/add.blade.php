...
@section('title', config('app.name'). '| Ajouter un candidat')
...
@if (Session::has('candidat_add'))
<span>{{ Session::get('candidat_add')}}</span>
@endif

<form method="POST" action="{{route('app_save_candidat')}}">
    @csrf
